                      ...
                      <Card className="bg-light d-flex flex-row justify-content-between align-items-center p-2">
                        ...
                        >
                          <Button
                            ...
                            size="sm"
                            onClick={() =>
                              removeFriend({ variables: { userId: f._id } })
                            }
                          >
                            Remove
                          </Button>
                    ...
                    <Col key={f._id} xs={12}>
                      <Card className="bg-warning-subtle d-flex flex-row justify-content-between align-items-center p-2">
                        ...
                        <div>
                          <OverlayTrigger
                            overlay={
                              <Tooltip id={`accept-${f._id}`}>Accept</Tooltip>
                            }
                          >
                            <Button
                              variant="success"
                              ...
                              className="me-2"
                              onClick={() =>
                                acceptRequest({ variables: { userId: f._id } })
                              }
                            >
                              Accept
                            </Button>
                          ...
                          <OverlayTrigger
                            overlay={
                              <Tooltip id={`decline-${f._id}`}>Decline</Tooltip>
                            }
                          >
                            <Button
                              variant="warning"
                              size="sm"
                              onClick={() =>
                                declineRequest({ variables: { userId: f._id } })
                              }
                            >
                              Decline
                            </Button>
              ...
              <Card.Body>
                ...
                <div className="mt-3">
                  ...
                  {searchData?.searchUsers?.map((u: any) => {
                    ...
                    const isPending = user?.friendRequestsSent?.some(
                      (f: any) => f._id === u._id
                    );
                    return (
                        ...
                        <Card.Body className="d-flex align-items-center justify-content-between">
                          ...
                          {isFriend ? (
                            ...
                            <Button
                              ...
                              variant="success"
                              onClick={() =>
                                sendRequest({ variables: { userId: u._id } })
                              }
                            >
                              Add Friend
                            </Button>
